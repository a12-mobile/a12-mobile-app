         ...
         data() {
            return {
                ...
                columns: [
                    ...
                    {field: 'jinghao', width: 50, columnAlign: 'center', columnAlign: 'center', isFrozen: false},
                ...
                titleRows: [ //第一行
                             [{fields: ['shigongdanwei'], title: '施工单位', titleAlign: 'center', rowspan: 4,titleCellClassName:'wu-title-cell-fixed'},
                              ...
                              {fields: ['zuantouchicun','zuanya','pailiang','chunzuanshijian','zuansu','jixiezuansu','bengya'], title: '钻头及钻井参数', titleAlign: 'center', colspan: 7},
                              {fields: ['sheji','shiji','niandu','shishui','hansha'], title: '钻井液性能', titleAlign: 'center', colspan: 5},
                              {fields: ['taoguanguige','zuanjuzuhe',], title: '套管及钻具', titleAlign: 'center', colspan: 2},
                             ],
