      ...
      <div class="row">
        ...
        <div class="col-4 oms2-g-grid-cell">
            <router-link to="/mlogsOfRecordWell">
              <img class='oms2-g-grid-cell-image' src="./../../assets/icon/mlog/daily.png">
            </router-link>
            <p>分队动态</p>
          </div>
          <div class="col-4 oms2-g-grid-cell">
            <router-link to="/mlogMonthOfTeam">
              <img class='oms2-g-grid-cell-image' src="./../../assets/icon/mlog/monthlyByTeam.png">
            </router-link>
            <p>队伍统计月报</p>
          </div>
          ...
          <div class="col-4 oms2-g-grid-cell">
            <router-link to="/MonthLogOfLogWellByCompany">
              <img class='oms2-g-grid-cell-image' src="./../../assets/icon/mlog/monthlyByMarket.png">
            </router-link>
            <p>分单位月报</p>
          </div>
      </div>
...
<script>
  ...
  export default {
    data(){
      ...
      created(){
        this.$ruixin.setWebViewTitle({title:'录井专业'})
      },
    }
</script>
