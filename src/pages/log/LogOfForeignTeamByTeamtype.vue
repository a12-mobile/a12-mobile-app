<template>
  <div>
    ...
    <div id="LogOfForeignTeamByTeamtype">
      <!-- <h4>测井工作量油区分布统计表</h4> -->
      ...
      ></v-table>
      <div class='oms2-g-report-float-right'>数据来源于A7集团系统测井专业队伍国外分布(按队伍类型)表</div>
      <!-- Modal 具体数据信息 -->
...
<script>
  ...
  import { getForeignTeamByTeamtype } from './../../service/log/logGetData'
  ...
  export default {
      ...
      return {
        ...
        titleRows: [
          ...
          [{fields: ['juOrgabb','chuOrgabb','p2Name'], title: '队伍类型', titleAlign: 'center', rowspan:2, colspan:3},
            ...
            {fields: ['centerAsiaTotal','kazakhstan','uzbekistan'], title: '中亚', titleAlign: 'center', colspan: 3},
    ...
    mounted(){
      // this.$ruixin.setWebViewTitle({title:'专业队伍国外分布表(按队伍类型)'});
